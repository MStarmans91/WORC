...
This is an open-source python package for the easy execution of full
Radiomics pipelines.
...
This package is under heavy development. We try to thoroughly test and
...
WORC has currently only been tested on Unix with Python 2.7. The package
...
Several tools have some prerequisites which are listed below. We highly
recommend you to install these to maximally profit from our toolbox.
...
We use the XNATpy package to connect the toolbox to XNAT online database
...
Check the WORC/fastrconfig/config.py file for the necessary additions.
...
`WORC email
list <https://groups.google.com/forum/#!forum/worc-users>`__.

We welcome contributions to WORC. We will soon make some guidelines. For
the moment, converting your toolbox into FASTR will be satisfactory.
